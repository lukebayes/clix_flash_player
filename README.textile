...
This project was created because unlike the modern distributions of the desktop debug Flash Player on Windows and Linux, the OS X distribution does not behave properly at all.

h1. The Problem(s)

We need to be able to execute and focus a specific instance of the Flash Player along with a specific SWF file. The Flash Player execution thread should block until:
...
h3. <code>exec</code> Flash Player.app/Contents/MacOS/FlashPlayer with SWF argument
