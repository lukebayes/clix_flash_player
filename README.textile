...
The only solution that I've been able to get consistently working, is to fork on the AppleScript features and use Process.kill when we interrupt the application.

An example of this process can be seen in exploration/rb-appscript
